        ...
        <div className="-mx-4 flex flex-col items-center gap-6 sm:flex-row">
          <div className="w-full px-4 lg:w-1/2">
            <div className="wow fadeInUp max-w-[470px]" data-wow-delay=".2s">
              <div className="mb-9">
                <h3 className="mb-4 text-xl text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">Bug free code</h3>
              ...
              <div className="mb-9">
                <h3 className="mb-4 text-xl text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                  Premier support
                </h3>
                <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
              ...
              <div className="mb-1">
                <h3 className="mb-4 text-xl text-black dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">Next.js</h3>
                <p className="text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
